        ...
        <section className='  z-50 w-full '>
            <nav  className="container mx-auto px-4 py-4 ">
                <div className="lg:flex lg:items-center lg:justify-between">
                    ...
                    >
                        <div className="flex -mx-6 lg:items-center lg:mx-8 space-x-5">
                            {/* search  */}
                            ...
                            <NavLink to='/' end className={({ isActive }) => isActive ? "underline text-primary font-semibold hover:bg-[#E9ECEF] p-2 rounded-full" : ""}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g mask="url(#mask0_140_1089)">
                                        <path d="M4 19V10C4 9.68333 4.07083 9.38333 4.2125 9.1C4.35417 8.81667 4.55 8.58333 4.8 8.4L10.8 3.9C11.15 3.63333 11.55 3.5 12 3.5C12.45 3.5 12.85 3.63333 13.2 3.9L19.2 8.4C19.45 8.58333 19.6458 8.81667 19.7875 9.1C19.9292 9.38333 20 9.68333 20 10V19C20 19.55 19.8042 20.0208 19.4125 20.4125C19.0208 20.8042 18.55 21 18 21H15C14.7167 21 14.4792 20.9042 14.2875 20.7125C14.0958 20.5208 14 20.2833 14 20V15C14 14.7167 13.9042 14.4792 13.7125 14.2875C13.5208 14.0958 13.2833 14 13 14H11C10.7167 14 10.4792 14.0958 10.2875 14.2875C10.0958 14.4792 10 14.7167 10 15V20C10 20.2833 9.90417 20.5208 9.7125 20.7125C9.52083 20.9042 9.28333 21 9 21H6C5.45 21 4.97917 20.8042 4.5875 20.4125C4.19583 20.0208 4 19.55 4 19Z" fill="#333333" />
                                    </g>
                                </svg>
